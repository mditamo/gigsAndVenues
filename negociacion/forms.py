...
class NegociacionComplejoFormPaso1(ModelForm):
    ...
    class Meta:
        model = Negociacion
        exclude = ('fecha,hora,banda,sede,evento,monto,complejo,tipo_banda,inicio_negociacion,estado')
...
class NegociacionComplejoFormPaso2(ModelForm):
    ...
    class Meta:
        model = Negociacion
        exclude = ('fecha,hora,sede,evento,monto,complejo,tipo_banda,inicio_negociacion,estado,nombre')
